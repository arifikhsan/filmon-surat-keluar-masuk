              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <select name="letter_type" class="form-control" required>
                    ...
                    <option value="Surat Masuk" {{ (old('letter_type')=='Surat Masuk' )? 'selected' :''; }}>Surat Masuk
                    </option>
                    <option value="Surat Keluar" {{ (old('letter_type')=='Surat Keluar' )? 'selected' :''; }}>Surat
                      Keluar</option>
                  </select>
                </div>
                @error('letter_type')
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control @error('letter_no') is-invalid @enderror"
                    value="{{ old('letter_no') }}" name="letter_no" placeholder="Nomor Surat.." required>
                </div>
                @error('letter_no')
                <div class="invalid-feedback">
                  {{ $message; }}
