              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <select name="letter_type" class="form-control" required>
                    ...
                    <option value="Surat Masuk" {{ ($item->letter_type == 'Surat Masuk')? 'selected':''; }}>Surat Masuk
                    </option>
                    <option value="Surat Keluar" {{ ($item->letter_type == 'Surat Keluar')? 'selected':''; }}>Surat
                      Keluar</option>
                  </select>
                </div>
                @error('letter_type')
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control @error('letter_no') is-invalid @enderror"
                    value="{{ $item->letter_no }}" name="letter_no" placeholder="Nomor Surat.." required>
                </div>
                @error('letter_no')
                <div class="invalid-feedback">
                  {{ $message; }}
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="date" class="form-control @error('letter_date') is-invalid @enderror"
                    value="{{ $item->letter_date }}" name="letter_date" required>
                </div>
                @error('letter_date')
                <div class="invalid-feedback">
                  {{ $message; }}
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="date" class="form-control @error('date_received') is-invalid @enderror"
                    value="{{ $item->date_received }}" name="date_received" required>
                </div>
                @error('date_received')
                <div class="invalid-feedback">
                  {{ $message; }}
